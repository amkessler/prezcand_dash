...
===================================== 
Trips from Nov 6 through `r format(today("EST"), format="%B %d")`. To filter, click on the boxes above the columns. To sort, use the up/down arrows by the column names. (Last updated on `r format(Sys.time(), format="%B %d %I:%M %Z")`)
...
### Map of all cities known in the coming week (PLACEHOLDER - MAPPING CODE REMOVED FOR RCONNECT COMPATIBILITY TEST)
