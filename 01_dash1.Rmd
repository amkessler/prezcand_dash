...
===================================== 
Trips from Nov 6 through `r format(Sys.Date(), format="%b %d")`. To filter, click on the boxes above the columns. To sort, use the up/down arrows by the column names. (Last updated on `r format(Sys.time(), format="%B %d %I:%M %Z")`)
...
### Map of visits per state in the coming week
