...
===================================== 
Trips from Nov 6 through `r format(d, format="%b %d")`. To filter, click on the boxes above the columns. To sort, use the up/down arrows by the column names. (Last updated on `r format(t, format="%B %d %I:%M %Z")`)
...
# Creating a color palette based on the number range in the total column
pal <- colorNumeric("Purples", domain=states_merged_sb$total)
...
### Upcoming scheduled trips (subject to change)
